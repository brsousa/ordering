...
public class Order {
    ...
    public Order(OrderId id, CustomerId customerId, Money totalAmount, Quantity totalItems, OffsetDateTime placeAt,
    ...
    private void setPlaceAt(OffsetDateTime placeAt) {
